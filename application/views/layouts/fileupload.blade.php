...
<!-- Navbar -->
  ...
  <div class="container">
          ...
          <div class="sidebar-nav">
            <div class="well" style="padding: 8px 0;">
                <ul class="nav nav-list"> 
                  ...
                  <li class="{{ URI::is('/') ? 'active' : '' }}"><a href="/"><i class="icon-home"></i> Dashboard</a></li>
                  <li><a href="#"><i class="icon-envelope"></i> Messages </a></li>
                  <li><a href="#"><i class="icon-comment"></i> Comments </a></li>
                  <li><a href="#"><i class="icon-user"></i> Members</a></li>
                  <li class="{{ URI::is('files') ? 'active' : '' }}" ><a href="#"><i class="icon-file-alt"></i> Manage Files</a></li>
                  <li class="divider"></li>
      ...
      {{ HTML::script('bundles/jqueryfileupload/js/jquery.ui.widget.js') }}
	    ...
	    {{ HTML::script('bundles/jqueryfileupload/js/main.js') }}        
    </body>
</html>